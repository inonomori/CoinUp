...
#define TICKER_URL @"http://www.chbtc.com/data/ticker"
#define TRADE_URL @"http://www.chbtc.com/data/trades"
#define DEPTH_URL @"http://info.btc123.com/lib/jsonProxyEx.php?type=chbtcDepth"
#define PLATFORM CHBTC

@implementation NRCHBTCTicker
...
- (void)update:(id)userInfo
{
    ...
    __weak NRCHBTCTicker* weakSelf = self;
